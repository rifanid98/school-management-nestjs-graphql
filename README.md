**school-management-nestjs-graphql** is a simple api endpoint built with Node.js, NestJs as a framework of Node.js and MongoDB as a database which has [features](#features).
